...
public class ShopEntityRegistry {
    ...
    public static void onEntityInteract(PlayerInteractEvent.EntityInteract event) {
        ...
        if (!CompoundTagCompat.hasUUID(persistentData, ShopNpcEntity.NBT_SHOP_ID)) return;

        // It's a NeoEssentials NPC shop — cancel vanilla interaction
        event.setCanceled(true);

        UUID shopId = CompoundTagCompat.getUUID(persistentData, ShopNpcEntity.NBT_SHOP_ID);
